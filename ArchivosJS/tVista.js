...
document.getElementById("btn-10").addEventListener("click", function() {
    // Coloca la URL de la otra vista o página web que deseas abrir en el siguiente enlace:
    window.location.href = "otro_valor.html"; // Reemplaza "otra-vista.html" con la URL deseada
});

document.getElementById("btn-4").addEventListener("click", function() {
    // Coloca la URL de la otra vista o página web que deseas abrir en el siguiente enlace:
    window.location.href = "resultado_retiro.html"; // Reemplaza "otra-vista.html" con la URL deseada
});
